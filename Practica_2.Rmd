...
La tecnica L1 de regularización o tambien llamada Lasso Regression, límita la capacidad e la red actuando en su algoritmo de entranamiento, penalizando los pesos grandes en función de sus valores abosultos.
...
### Dropout
Esta tecnica consiste en establecer a 0 una fracción del input (establecida a 0.5) en cada actualización durante el proceso de entrenamiento, con lo que conseguimos prevenir el overfitting.
...
Despues de corregir el overfiting hay que asegurrar que el modelo mantiene el acurract mostrado, y para esto utilizamos crossvalidación.
